...
@login_required
def employee_agent_home(request):
    return render(
        request,
        "pegasus/employees/employees_agentic.html",
        {"active_tab": "object_lifecycle", "employees": Employee.objects.filter(user=request.user)},
    )


@login_required
def employee_agent_list(request):
    return render(
        request,
        "pegasus/employees/components/employee_table.html",
        {"active_tab": "object_lifecycle", "employees": Employee.objects.filter(user=request.user)},
    )
