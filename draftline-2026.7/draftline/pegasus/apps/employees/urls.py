...
urlpatterns = [
    ...
    path("objects/agent/", views.employee_agent_home, name="agentic_object_lifecycle"),
    path("objects/agent/list/", views.employee_agent_list, name="agentic_object_lifecycle_list"),
