"""
Django settings for Draftline project.
...
SECRET_KEY = env("SECRET_KEY", default="django-insecure-u88Rz3IURJksDn0NB1KNCa3fPJZ7UFOfTAgSGEMC")
...
WSGI_APPLICATION = "draftline.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="draftline"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "draftline_language"
LANGUAGES = [
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="draftline-media")
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="muhasin@gauger.in")
...
EMAIL_SUBJECT_PREFIX = "[Draftline] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Draftline",
    "DESCRIPTION": "Application to build SaaS platforms",  # noqa: E501
    "VERSION": "0.1.0",
...
CACHES = {
    ...
    # Locks and idempotency keys must survive DEBUG's dummy cache, so they always use Redis.
    "locks": REDIS_CACHE,
}
...
CELERY_TASK_ROUTES = {
    "tickets.backfill_gorgias": {"queue": "backfill"},
    "apps.tickets.tasks.backfill_gorgias_tickets": {"queue": "backfill"},
...
# Tenant credential encryption (Fernet locally; set CREDENTIAL_ENCRYPTOR=kms in GCP)
CREDENTIAL_ENCRYPTION_KEY = env("CREDENTIAL_ENCRYPTION_KEY", default="")
CREDENTIAL_ENCRYPTOR = env("CREDENTIAL_ENCRYPTOR", default="fernet")
CREDENTIAL_KMS_KEY_NAME = env("CREDENTIAL_KMS_KEY_NAME", default="")
DRAFT_SHADOW_MODE_DEFAULT = env.bool("DRAFT_SHADOW_MODE_DEFAULT", default=True)

# Platform website crawler (Draftline-owned Apify; tenants never supply keys)
APIFY_API_KEY = env("APIFY_API_KEY", default="")
APIFY_ACTOR = env("APIFY_ACTOR", default="")  # set to custom actor id when ready
...
ASGI_APPLICATION = "draftline.asgi.application"
CHANNEL_LAYERS = {
    "default": {
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("Draftline"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("Application to build SaaS platforms"),  # noqa: E501
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "muhasin@gauger.in",
}

# set this to True in production to have URLs generated with https instead of http
USE_HTTPS_IN_ABSOLUTE_URLS = env.bool("USE_HTTPS_IN_ABSOLUTE_URLS", default=False)

ADMINS = ["muhasin@gauger.in"]
...
# Ticket qualification (hybrid LLM stage)
QUALIFIER_LLM_CONFIDENCE_MIN = env.float("QUALIFIER_LLM_CONFIDENCE_MIN", default=0.8)
QUALIFIER_LLM_SUPPORT_CONFIDENCE_MIN = env.float("QUALIFIER_LLM_SUPPORT_CONFIDENCE_MIN", default=0.85)
QUALIFIER_BACKEND = env("QUALIFIER_BACKEND", default="rules")  # rules | hybrid | llm
...
AZURE_OPENAI_CHAT_DEPLOYMENT_NAME = env("AZURE_OPENAI_CHAT_DEPLOYMENT_NAME", default="")
AZURE_OPENAI_EMBEDDING_DEPLOYMENT_NAME = env(
...
LOGGING = {
    ...
    "loggers": {
        ...
        "apps": {
            "handlers": ["console"],
            "level": env("DRAFTLINE_LOG_LEVEL", default="INFO"),
        },
        "pegasus": {
            "handlers": ["console"],
